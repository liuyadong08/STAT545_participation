...
```
    ...
    ## # A tibble: 2,888 x 17
    ##     year tailnum carrier time_hour           orig… month   day  hour  temp
    ##    <dbl> <chr>   <chr>   <dttm>              <chr> <dbl> <int> <int> <dbl>
    ##  1  2013 N14228  UA      2013-01-01 05:00:00 EWR    1.00     1     5  39.0
    ##  2  2013 N14228  UA      2013-01-01 05:00:00 JFK    1.00     1     5  39.0
    ##  3  2013 N14228  UA      2013-01-01 05:00:00 LGA    1.00     1     5  39.9
    ##  4  2013 N24211  UA      2013-01-01 05:00:00 EWR    1.00     1     5  39.0
    ##  5  2013 N24211  UA      2013-01-01 05:00:00 JFK    1.00     1     5  39.0
    ##  6  2013 N24211  UA      2013-01-01 05:00:00 LGA    1.00     1     5  39.9
    ##  7  2013 N619AA  AA      2013-01-01 05:00:00 EWR    1.00     1     5  39.0
    ##  8  2013 N619AA  AA      2013-01-01 05:00:00 JFK    1.00     1     5  39.0
    ##  9  2013 N619AA  AA      2013-01-01 05:00:00 LGA    1.00     1     5  39.9
    ## 10  2013 N804JB  B6      2013-01-01 05:00:00 EWR    1.00     1     5  39.0
...
```
    ...
    ## # A tibble: 2,888 x 18
    ##    year.x tailnum carri… time_hour           orig… year… month   day  hour
    ##     <int> <chr>   <chr>  <dttm>              <chr> <dbl> <dbl> <int> <int>
    ##  1   2013 N14228  UA     2013-01-01 05:00:00 EWR    2013  1.00     1     5
    ##  2   2013 N14228  UA     2013-01-01 05:00:00 JFK    2013  1.00     1     5
    ##  3   2013 N14228  UA     2013-01-01 05:00:00 LGA    2013  1.00     1     5
    ##  4   2013 N24211  UA     2013-01-01 05:00:00 EWR    2013  1.00     1     5
    ##  5   2013 N24211  UA     2013-01-01 05:00:00 JFK    2013  1.00     1     5
    ##  6   2013 N24211  UA     2013-01-01 05:00:00 LGA    2013  1.00     1     5
    ##  7   2013 N619AA  AA     2013-01-01 05:00:00 EWR    2013  1.00     1     5
    ##  8   2013 N619AA  AA     2013-01-01 05:00:00 JFK    2013  1.00     1     5
    ##  9   2013 N619AA  AA     2013-01-01 05:00:00 LGA    2013  1.00     1     5
    ## 10   2013 N804JB  B6     2013-01-01 05:00:00 EWR    2013  1.00     1     5
    ## # ... with 2,878 more rows, and 9 more variables: temp <dbl>, dewp <dbl>,
    ## #   humid <dbl>, wind_dir <dbl>, wind_speed <dbl>, wind_gust <dbl>, precip
    ## #   <dbl>, pressure <dbl>, visib <dbl>
...
```
    ...
    ## # ... with 27,105 more rows, and 8 more variables: dewp <dbl>, humid
    ## #   <dbl>, wind_dir <dbl>, wind_speed <dbl>, wind_gust <dbl>, precip
    ## #   <dbl>, pressure <dbl>, visib <dbl>
