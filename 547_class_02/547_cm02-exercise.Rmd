...
```{r}
index <- c(1:12)
(num <- str_pad(index, width = 2, side = "left", pad = "0"))
```
...
```{r}
str_view_all_match(countries, pattern="(e{2}|a{2}|ae|ea)") # or pattern = "(a|e)(a|e)"
```
...
```{r}
str_view_all(c("abad", "abbd"), pattern="(a)(b)\\1") # the last digit "1" indicate that i want another thing in gourp 1, which is (a)
