...
yvsl <- ggplot(gapminder, aes(year, lifeExp)) +
  scale_x_log10()
yvsl + geom_point(aes(color=continent)) + geom_smooth(aes(group=continent, color = continent))
```
...
yvsl <- ggplot(gapminder, aes(year, lifeExp)) +
  scale_x_log10()
yvsl + geom_smooth(aes(group=continent, color = continent)) + geom_point(aes(color=continent)) 
```
...
yvsl <- ggplot(gapminder, aes(year, lifeExp)) +
  scale_x_log10()
yvsl + geom_smooth(aes(group=continent, color = continent))
```
...
```{r}
yvsl + geom_point() + geom_smooth(aes(group=continent)) + facet_wrap(~continent)
```
